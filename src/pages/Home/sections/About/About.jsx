  ...
  return (
    <>
        ...
        >
          {GALLERY_IMAGES.map((src, i) => (
            <div className={styles.galleryItem} key={i}>
              <img src={src} alt={`SVT Constructions project ${i + 1}`} />
            </div>
          ))}
        </div>
      </div>
      ...
      <div className={styles.section}>
        <h2>About SVT Constructions</h2>
        <p>
          For over two decades, SVT Constructions has been shaping skylines and
        ...
        <p>
          ...
          SVT Constructions continues to do what we've always done — build
