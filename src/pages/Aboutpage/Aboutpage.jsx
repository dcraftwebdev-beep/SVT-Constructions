      ...
      <section className={styles.hero} ref={heroRef}>
        ...
        <div className={styles.heroInner}>
          <h1 className={styles.heroTitle} ref={heroTitleRef}>
            <span className={styles.heroMask}><span className={styles.heroWord}>SVT</span></span>
            <span className={styles.heroMask}><span className={styles.heroWord}>Constructions</span></span>
          </h1>
