...
import logo from '../../assests/svtlogo3.png';
      ...
      <div className="container">
        ...
        <div className={styles.brand}>
          <Link to="/" className={styles.logoLink}>
            <img src={logo} alt="SVT Constructions" className={styles.logo} />
            {/* <span className={styles.logoText}>SVT Constructions</span> */}
          </Link>
          <p className={styles.tagline}>
            SVT Constructions is dedicated to transforming visions into<br />
        ...
        <div className={styles.infoGrid}>
          ...
          <div className={styles.infoCol}>
            ...
            <div className={styles.socials}>
              <a href="https://www.instagram.com/svtconstructions" target="_blank" rel="noopener noreferrer">
                <FaInstagram />
              </a>
              <a
              ...
              <a
                href="mailto:svtconstructions@gmail.com"
                aria-label="Email"
              >
                <FaEnvelope />
              </a>
              {/* <a href="#"><FaBehance /></a> */}
              {/* <a href="https://www.linkedin.com/company/svtconstructions" target="_blank" rel="noopener noreferrer">
                <FaLinkedinIn />
              </a> */}
            </div>
          </div>
        ...
        <div className={styles.bottom}>
          <span>© {year} SVT Constructions. All rights reserved.</span>
